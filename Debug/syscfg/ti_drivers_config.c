...
GPIO_PinConfig gpioPinConfigs[] = {
    ...
    /* US4_ECHO */
    GPIOCC32XX_GPIO_30 | GPIO_CFG_IN_PD | GPIO_CFG_IN_INT_BOTH_EDGES,
    /* US2_ECHO */
    GPIOCC32XX_GPIO_06 | GPIO_CFG_IN_PD | GPIO_CFG_IN_INT_BOTH_EDGES,
    /* US3_ECHO */
    GPIOCC32XX_GPIO_07 | GPIO_CFG_IN_PD | GPIO_CFG_IN_INT_BOTH_EDGES,
    /* US1_ECHO */
 ...
 */
extern void getTime(uint_least8_t index);
...
const uint_least8_t US2_TRIGGER_CONST = US2_TRIGGER;
const uint_least8_t US3_TRIGGER_CONST = US3_TRIGGER;
const uint_least8_t US4_TRIGGER_CONST = US4_TRIGGER;
const uint_least8_t US4_ECHO_CONST = US4_ECHO;
const uint_least8_t US2_ECHO_CONST = US2_ECHO;
